class UTMLatLng {
    ...
    constructor(datumNameIn2) {
        console.warn('@@@ Are we here ???')

        if (datumNameIn2 !== undefined)
            {
                this.#datumName = datumNameIn2;
            }
            this.#setEllipsoid(this.#datumName);
    }

    convertLatLngToUtmFixedZone(zone, latitude, longitude,precision){
